...
As a product, My Bets allows our customers to view, track and cashout any of their bets. Bets these days are complex, they can consist of many selections consisting of multiple outcomes across multiple events - oh, and then we need to track the history of a bet i.e. all the data at the time it was placed and compare it to the data of the bet, if you were to place the same one now.

![My Bets Overview](/images/mybets-TypeScript/mybets-overview.png)
...
![My Bets Overview](/images/mybets-TypeScript/custom-types.png)
